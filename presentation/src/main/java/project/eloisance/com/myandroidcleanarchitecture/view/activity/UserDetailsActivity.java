...
public class UserDetailsActivity extends BaseActivity implements HasComponent<UserComponent> {
    ...
    private static final String INTENT_EXTRA_PARAM_USER_ID = "com.cleverage.INTENT_PARAM_USER_ID";
    private static final String INSTANCE_STATE_PARAM_USER_ID = "com.cleverage.STATE_PARAM_USER_ID";
